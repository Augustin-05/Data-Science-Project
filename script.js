...
Promise.all([ 
  ...
  function updateRadar(countryA, countryB) {
    ...
    d3.select("#radar-chart").html(""); // Clear previous chart
  ...
  function updateComparison() {
    ...
    let html = `<table 
    class="comparison-table"><thead><tr><th>Metric</th><th>${a.Country}</th><th>${b.Country}</th></tr></thead><tbody>`;
    metrics.forEach(key => {
    ...
    updateRadar(a, b); // show both countries on radar chart
  }
